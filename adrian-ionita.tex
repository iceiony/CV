...
\ind \hspace{0.354in} \footnotesize \textbf{Python}, \textbf{R}, \textbf{SQL}, MATLAB, \textbf{AWS}, \textbf{Docker}, C/C++, JavaScript, C\#, CUDA \normalsize 
...
\begin{itemize*}
  \item Given a small set of data, determine which records need acquiring to achieve a representative view of the input space.
...
\end{itemize*}
\ind \hspace{0.35in} \footnotesize \emph{Key Technologies: Python, SQL, R, Node.js, AWS, Bayesian Modeling / Probabilistic Programming}
