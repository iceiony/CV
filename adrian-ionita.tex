...
\normalsize
\medskip
\ind Accessibility Application Developer, Iceiony LTD - \emph{founder} \hfill Apr 2025 - Current
\begin{itemize*}
    \item Designing and developing a visual calendar mobile application to support the wellbeing of autistic/neurodivergent people. 
    \item Integrating with existing calendar systems to provide a unified and familiar view of events.
    \item Ensuring application reliability through automated testing on Android and FireOS platforms.
\end{itemize*}
\ind \hspace{0.35in} \footnotesize \emph{Key Skills: Kotlin, Android, TDD}
