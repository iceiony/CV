...
\begin{itemize*}
    ...
    \item Optimising R functionality to bring large performance improvements on Azure. 
    \item Automating tests and providing the wider team with R packages, easing acceptance testing (UAT).
    \item Automating detection and remediation of non-cloud compatible R code on thousands of scripts, saving time and enabling repeatability.
