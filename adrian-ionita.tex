...
\ind \hspace{0.354in} \textbf{Imbalanced Learning}, Algorithms, \textbf{Large Language Models}, Anomaly Detection, Entity Resolution,
...
\ind \hspace{0.354in} \textbf{Natural Language Processing} (NLP), \textbf{Deep Learning} (Classification \& Regression), \textbf{Decision Trees / Random Forests},
    RNN, RBF Networks, SOM, Committee Machines, Reinforcement Learning, Improving Generalisation \& Training Speed, PyTorch, Dynet, Ollama
...
\begin{itemize*}
    \item Transforming proof of concept audio trascription models into production ready software.
    \item Productionising text procesisng pipelines involving LLM agents to structure and extract information from dialogue.
\end{itemize*}
\ind \hspace{0.35in} \footnotesize \emph{Key Skills: Python, TDD, Ollama, LLM Agents, Whisper ASR, NLP}
