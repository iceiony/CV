...
\begin{itemize*}
    ...
    \item Exposing prediction reasoning to investigators to help them understand the model's decision making process.
    ...
    \item Predicting the duration of fraud investigations to prioritide cases by the best financial outcome.
\end{itemize*}
...
\normalsize
\medskip
\ind Data Science Engineer, South West Business Intelligence - \emph{contract} \hfill Mar 2023 - Apr 2023
\begin{itemize*}
