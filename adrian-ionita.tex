...
\normalsize
\medskip
\ind Data Scientist - NLP, EDF Energy - \emph{contract} \hfill Dec 2018 - Current
\begin{itemize*}
    \item Consulting the business on AI/ML capabilities and less popular known limitations, shaping long term AI strategies
    \item Identifying value opportunities from applied data-science modeling and language processing automation
    \item Delivering insights platform into customer queries, focusing to automation effort via chat-bots to high volume scenarios
    \item Developing new algorithms to improve the accuracy to standard unsupervised learning techniques, improving query classification with little training data  
\end{itemize*}
\ind \hspace{0.35in} \footnotesize \emph{Key Technologies: Python, LDA topic modeling, CorEx topic modeling }
