...
\begin{itemize*}
    \item Designing the system artictecture for a product linking information across public sources of data at scale and with a focus on strict operational security.
    \item Developing data cleanup and entity resolution algorithms to identify the same entity (e.g. person or company) across different sources.
    \item Coordinating team members to deliver a feasible and useful solution to the end client. 
\end{itemize*}
...
\begin{itemize*}
    ...
    \item Driving the product design by leveraging the arf of the possible in AI/ML to enhance the end user prodictivity.
    ...
    \item Predicting the duration of investigations to prioritide cases by the best financial outcome.
\end{itemize*}
