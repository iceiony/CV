...
\normalsize
\medskip
\ind Data Analyst / Scientist, EDF Trading - \emph{contract} \hfill Nov 2021 - current
\begin{itemize*}
    \item Deriving from raw market data the exact logic for extracting trades and constructing candlesticks, 
        enabling end users historic access to the trading market 
\end{itemize*}
...
\begin{itemize*}
    ...
    \item Automating tests and providing the wider team with R packages, easing acceptance testing (UAT).
    \item Automating remediation of non-cloud compatible R code on thousands of scripts, saving time and enabling repeatability.
    \item Providing the R tools and expertise needed by the actuarial team for an efficient day to day operation.
    \item Training acturials on R best practices, improving the reliability of their code.
\end{itemize*}
