...
\normalsize
\medskip
\ind Mission Engineer (i.e. Data Science Engineer), Adarga - \emph{contract} \hfill Sep 2025 - Current
\begin{itemize*}
    \item Transforming proof of concept audio trascription models into production ready systems.
\end{itemize*}
\ind \hspace{0.35in} \footnotesize \emph{Key Skills: Python, TDD, Large Model Integration}

\normalsize
\medskip
\ind Quant Developer, Iceiony LTD - \emph{founder} \hfill Apr 2025 - Paused
\begin{itemize*}
  ...
  \item Develped a general understanding on energy availability constraints for cypto mining and the impact on price.
\end{itemize*}
...
\begin{itemize*}
    ...
    \item Implementing liquidity algorithm for a more representative view of the market.
    \item Developing prediction algorithm for next day's price correlations (96.5\% accuracy); to estimate future profit and loss. 
    \item Attaining general knowledge about the energy market, e.g.: grid balancing, battery storage, PPA contracts, maintenance windows, carbon phases and voluntary markets.
\end{itemize*}
