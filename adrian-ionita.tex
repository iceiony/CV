...
\ind \hspace{0.354in} \footnotesize  \textbf{R}, \textbf{Python}, \textbf{SQL}, MATLAB, AWS, \textbf{Docker}, C/C++, JavaScript, C\#, CUDA, ElasticSearch, MongoDB \normalsize 
...
\begin{itemize*}
    \item Supporting the capital modelling team in the smooth migration to Azure.
    \item Automating tests and providing the wider team with R packages that ease the UAT process.
    \item Automating code issue detection and fixes on thousands of R scripts, saving time and enabling repeatability.
