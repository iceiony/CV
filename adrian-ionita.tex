...
\begin{itemize*}
    \item Designing system artictecture for product linking information across public sources at scale.
    \item Developing data cleanup and entity resolution algorithms to identify the same entity (e.g. person or company) across different data-sources.
\end{itemize*}
